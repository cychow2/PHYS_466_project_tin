...
def plot():
    ...
    ax = fig.gca()
    ax.set_title(rf"Mean internal energy per atom of $\alpha$-tin at different temperatures")
    ...
    fig = plt.figure(figsize = (16, 9))
    ax = fig.gca()
    ax.set_title(rf"Measured mean pressure of $\alpha$-tin at different temperatures")
    ax.set_xlabel("temperature (K)")
